...
ElvCharacterDB = {
	...
	["ChatEditHistory"] = {
		" and make my lock nb on horde", -- [1]
		" But dno which server or faction I will play next expansion, horde guild isn't gonna survive", -- [2]
		" So I'll just boost one race once i know that", -- [3]
		" booooooring", -- [4]
		"Ye but I still have vast majority as alliance", -- [5]
		"not yet", -- [6]
		"/WA", -- [7]
		"/1 imagine if Jaina was still a pacifist, Alliance would fall", -- [8]
		"/s Greymane for king", -- [9]
		"/1 Khadgar", -- [10]
		"But dno which server or faction I will play next expansion, horde guild isn't gonna survive", -- [11]
		"booooooring", -- [12]
		"/1 Jaina is a dreadlord, how else could she be this powerful", -- [13]
		"me2", -- [14]
		"Ye I'll lvl a void elf lock as alliance", -- [15]
		"So I'll just boost one race once i know that", -- [16]
		"I have everything at 110, so lvling a char feels kinda pointless", -- [17]
		"and make my lock nb on horde", -- [18]
		"I'll prolly lvl a lock since my lock is horde tho", -- [19]
		"not gonna pay to move'em all", -- [20]
	},
	["BodyGuard"] = {
		["IsInValidZone"] = true,
		["MaxHealth"] = 0,
