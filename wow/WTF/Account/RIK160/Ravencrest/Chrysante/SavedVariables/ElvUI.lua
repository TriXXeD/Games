...
ElvCharacterDB = {
	...
	["ChatEditHistory"] = {
		...
		"/i rekt", -- [2]
		"/i just like mythic progress kills :D", -- [3]
		"/cw Gnott-Terokkar do u need?", -- [4]
		"/roll", -- [5]
		"/i retard", -- [6]
		"/i Ellen is AFK", -- [7]
		"/i has been since the start", -- [8]
		"/i Keep ur taunt rdy for tank failures boys", -- [9]
		"/i U mean the healer that stands in death zones?", -- [10]
		"/i dps orbs thanks", -- [11]
		"/g Why would u pay it then :P", -- [12]
		"/g Don't you have any tea in ur house :P", -- [13]
		"/g Teatax, the real way the british government makes money", -- [14]
		"/g Why is the mage tower always destroyed on weekends", -- [15]
		"/g fml", -- [16]
		"/g Mage tower in all specs is my only purpose in WoW these days, but the timing", -- [17]
		"/elvui", -- [18]
		"/s  I can tank it if u want", -- [19]
		"/i 2 tanks :P?", -- [20]
	},
	["BodyGuard"] = {
		["Active"] = false,
