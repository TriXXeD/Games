--[[
	...
	Revision: $Id: Stubby.lua 6000 2018-07-17 14:09:34Z none $
...
LibStub("LibRevision"):Set("$URL: /Stubby.lua $","$Rev: 6000 $","5.1.DEV.", 'auctioneer', 'libs')
...
function getRevision()
	return tonumber(("$Rev: 6000 $"):match("(%d+)"))
end
