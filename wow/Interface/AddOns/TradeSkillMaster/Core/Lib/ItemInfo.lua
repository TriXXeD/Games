...
local L = TSM.L
local private = { db = nil, pendingItems = {} }
local SEP_CHAR = "\002"
...
function ItemInfo.OnInitialize()
	...
	TSMAPI_FOUR.Delay.AfterTime("processItemInfo", 0, private.ProcessItemInfo, 0.1)
...
function private.ProcessItemInfo()
	...
	for itemString in pairs(private.pendingItems) do
		...
		if name and name ~= "" and quality and quality >= 0 then
