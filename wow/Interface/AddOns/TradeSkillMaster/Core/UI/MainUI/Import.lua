...
function private.ExportGroupsSelectionChanged(element, selectedGroups)
	...
	local path = "__parent.__parent.__parent.__parent.groups.content.buttons.ExportRightPane.exportFeedback.exportConfirmationList"
	local exportConfirmationList = element:GetElement(path)
