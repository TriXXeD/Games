...
function private.GetAuctioningSettingsFrame()
	return TSMAPI_FOUR.UI.NewElement("ScrollFrame", "auctioningSettings")
		...
		:AddChild(TSMAPI_FOUR.UI.NewElement("Checkbox", "ahOption4Checkbox")
			:SetStyle("height", 28)
			:SetStyle("fontHeight", 12)
			:SetText(L["Show AuctionDB tab (requires reload)"])
			:SetSettingInfo(TSM.db.global.auctioningOptions, "showAuctionDBTab")
		)
		:AddChild(TSMAPI_FOUR.UI.NewElement("Checkbox", "ahOption5Checkbox")
			:SetStyle("height", 28)
			:SetStyle("margin.bottom", 24)
			:SetStyle("fontHeight", 12)
			:SetText(L["Open all bags when auctioning"])
			:SetSettingInfo(TSM.db.global.auctioningOptions, "openAllBags")
		)
		:AddChild(TSMAPI_FOUR.UI.NewElement("Text", "label")
			...
			:SetText(L["AH Rows Shown (requires reload)"])
		)
		:AddChild(TSMAPI_FOUR.UI.NewElement("Frame", "ahRowsFrame")
			:SetLayout("HORIZONTAL")
			:SetStyle("height", 20)
			:SetStyle("margin.bottom", 24)
			:AddChild(TSMAPI_FOUR.UI.NewElement("InputNumeric", "ahRowsInput")
				:SetStyle("height", 20)
				:SetStyle("width", 60)
				...
				:SetMinNumber(8)
				:SetMaxNumber(25)
				:SetSettingInfo(TSM.db.global.auctioningOptions, "ahRowDisplay")
			)
			:AddChild(TSMAPI_FOUR.UI.NewElement("Text", "label2")
				:SetStyle("height", 16)
				:SetStyle("fontHeight", 12)
				:SetText(L["(minimum 8 - maximum 25)"])
			)
		)
