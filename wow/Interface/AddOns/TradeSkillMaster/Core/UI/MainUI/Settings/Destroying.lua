...
function private.GetDestroyingSettingsFrame()
	return TSMAPI_FOUR.UI.NewElement("Frame", "destroyingSettings")
		...
		:AddChild(TSMAPI_FOUR.UI.NewElement("Text", "timeFormatHeadingDesc")
			:SetStyle("height", 18)
		...
		:AddChild(TSMAPI_FOUR.UI.NewElement("Frame", "timeFormatFrame")
			:SetLayout("HORIZONTAL")
			:SetStyle("height", 26)
			:SetStyle("margin.bottom",16)
			:AddChild(TSMAPI_FOUR.UI.NewElement("SelectionDropdown", "timeFormatDropdown")
				:SetItems(TIME_FORMAT_VALUES, TIME_FORMAT_KEYS)
				:SetSettingInfo(TSM.db.global.destroyingOptions, "timeFormat")
			)
			:AddChild(TSMAPI_FOUR.UI.NewElement("Spacer", "spacer"))
		)
		:AddChild(TSMAPI_FOUR.UI.NewElement("Text", "clearLogHeadingDesc")
			:SetStyle("height", 18)
			:SetStyle("margin.bottom", 4)
			:SetStyle("font", TSM.UI.Fonts.MontserratMedium)
			:SetStyle("fontHeight", 14)
		...
		:AddChild(TSMAPI_FOUR.UI.NewElement("Frame", "logDaysFrame")
			:SetLayout("HORIZONTAL")
			:SetStyle("height", 20)
			...
			:AddChild(TSMAPI_FOUR.UI.NewElement("InputNumeric", "moveDelayInput")
				...
				:SetMinNumber(0)
				:SetMaxNumber(30)
				:SetSettingInfo(TSM.db.global.destroyingOptions, "logDays")
			)
		...
		:AddChild(TSMAPI_FOUR.UI.NewElement("Checkbox", "abovePriceCheckbox")
			:SetStyle("height", 28)
			:SetStyle("margin.bottom", 22)
			:SetStyle("fontHeight", 12)
			:SetText(L["Above vendor sell price"])
			:SetSettingInfo(TSM.db.global.destroyingOptions, "deAbovePrice")
		)
