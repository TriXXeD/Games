...
function Cost.OnInitialize()
	private.db = TSMAPI_FOUR.Database.New(COST_DB_SCHEMA)
end
...
function Cost.UpdateDB()
	...
	for _, spellId in TSM.Crafting.SpellIterator() do
		...
		private.db:BulkInsertNewRow(spellId, craftingCost, itemValue, profit, saleRate)
	end
	private.db:BulkInsertEnd()
end

function Cost.GetDBForJoin()
	return private.db
end
