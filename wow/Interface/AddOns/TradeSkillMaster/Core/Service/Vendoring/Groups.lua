...
function private.SellItemThreaded(itemString, operationSettings)
	...
	local marketValue = TSMAPI:GetCustomPriceValue(operationSettings.vsMarketValue, itemString) or 0
	local maxMarketValue = TSMAPI:GetCustomPriceValue(operationSettings.vsMaxMarketValue, itemString) or 0
