...
function impOnEvent(self, event, ...)
	...
	zpetsimptotemcount1 = ((PetTotemSummonCount(1,deimptimetable,"Wild Imps")))
	zpetsimptotemcount2 = ((PetTotemSummonCount(2,deimptimetable,"Wild Imps")))
	zpetsimptotemcount3 = ((PetTotemSummonCount(3,deimptimetable,"Wild Imps")))
	zpetsimptotemcount4 = ((PetTotemSummonCount(4,deimptimetable,"Wild Imps")))
...
function ConsuptionValue()
	...
	local zpetsdemod = 1.5
	if SPMod > 0 then
		zpetsdemod = (1.5+(SPMod/100))
	end
	local thalkielshealthcost = .1
